...
<body>
    <div class="card">
        <div class="card-body">
            ...
            <div class="header2">
                <h1 class="text-center">SURAT KETERANGAN</h1>
                <p class="text-center">NOMOR: {{$surat->no_surat_skb}}/Ket/Amb/XI/{{ date('Y') }}</p>
            </div>
            ...
            <table class="font-12">
                ...
                <tr>
                    <td width="200px">E. Agama</td>
                    <td width="10px">:</td>
                    <td>{{$surat->pend->agama}}</td>
                </tr>
                <tr>
                    <td width="200px">F. Alamat</td>
                    <td width="10px">:</td>
