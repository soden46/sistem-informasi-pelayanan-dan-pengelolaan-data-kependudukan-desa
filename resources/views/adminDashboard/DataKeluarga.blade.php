    ...
    <div class="card" style="width: 100%; height: 100%; background-color: white; padding: 20px">
        ...
        <div>
            <div class="d-flex">
                ...
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#cretaeDataMasyarakat" style="margin-right: 15px">Tambah Data Keluarga</button>
                        ...
                        <form action="{{route('data-keluarga/store')}}" method="post">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="no_kk" id="no_kk" class="form-control @error('no_kk') is-invalid @enderror" required value="{{ old('no_kk') }}" autocomplete="off" placeholder="Input Nomor KK">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="sts_keluarga" id="sts_keluarga" class="form-control @error('sts_keluarga') is-invalid @enderror" required value="{{ old('sts_keluarga') }}" autocomplete="off" placeholder="Input Status Keluarga">
        ...
        <div class="table-responsive">
            <table class="table" style="text-align: left; color: black">
                ...
                <tr style="width: 100%">
                    ...
                    <td style="vertical-align: middle;  ">{{ $item->pend->padukuhan }}</td>
                    <td style="vertical-align: middle;  ">{{ $item->pend->rt }}</td>
                    <td style="vertical-align: middle;  ">{{ $item->pend->rw }}</td>
